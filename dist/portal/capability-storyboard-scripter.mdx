  ...
  inputs:
    ...
    - what: Persona consuming the storyboard (optional)
      description: >-
        ...
        Base/Programme-wide/Personas/*`. Useful when the audience is operators
        reviewing the capability for the first time.
...
- **Inputs** — CLARA will search the programme's Confluence space for operational scenario this storyboard depicts; capability spec for the capability being shown (optional); persona consuming the storyboard (optional). You can also paste fresh material if it's not in Confluence yet.
