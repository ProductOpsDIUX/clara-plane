...
- **Inputs** — CLARA will search the programme's Plane project for prior-knowledge summary on the topic (optional). You can also paste fresh material if it's not in Plane yet.

## Where the output lands

`Knowledge Base/{{track}}/Interview-guides/{{topic}}` inside your programme's Plane project.
