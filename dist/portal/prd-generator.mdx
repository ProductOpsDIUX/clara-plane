...
planeContext:
  inputs:
    ...
    - what: Original stakeholder ask
      description: >-
        Programme brief / charter / requesting note. Work items with 'brief',
        'ask', 'charter' in titles.
...
- **Inputs** — CLARA will search the programme's Plane project for problem statement and success criteria; persona for the prd; themes from the research synthesis (optional); original stakeholder ask. You can also paste fresh material if it's not in Plane yet.

## Where the output lands

`Knowledge Base/{{track}}/PRDs/{{prd-title}}` inside your programme's Plane project.
