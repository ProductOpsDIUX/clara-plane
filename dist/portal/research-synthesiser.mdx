  ...
  inputs:
    - what: >-
      ...
      description: >-
        ...
        'interview', 'transcript', 'session-notes', 'observation',
        'field-notes', 'exercise' in titles). Restrict to this programme's Plane
        project.
...
- **Inputs** — CLARA will search the programme's Plane project for interview transcripts, field/exercise observation notes, operator session notes; prior-knowledge summary on the topic (optional); interview guide used in the field (optional). You can also paste fresh material if it's not in Plane yet.

## Where the output lands

`Knowledge Base/{{track}}/Research-synthesis` inside your programme's Plane project.
